        ...
        <div class="flex items-center gap-6">
          ...
          <div class="space-y-3">
            <input type="file" name="foto" id="imageInput" class="hidden" accept="image/*"
                   ...
                   ">
            <label for="imageInput" class="inline-block cursor-pointer rounded-lg bg-blue-600 px-4 py-2 text-white hover:bg-blue-700">
              Escolher Nova Foto
            </label>
      ...
      <div x-show="showCropper" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50"
        ...
        <div class="bg-white rounded-lg p-4 w-full max-w-2xl">
          ...
          <div class="mt-4 flex justify-end gap-3">
            ...
            <button type="button" @click="applyCrop()" class="rounded-lg bg-green-600 px-4 py-2 text-white hover:bg-green-700">
              Aplicar Corte
            </button>
          </div>
        </div>
      ...
      <div class="mb-8 border-b pb-6">
        ...
        <div class="grid gap-4 md:grid-cols-2">
          ...
          <div>
            ...
            <input type="email" value="{{ $usuarioLogado->email }}" disabled class="w-full rounded-lg bg-gray-100 px-4 py-2 text-gray-700 disabled:opacity-75">
          </div>
        </div>
      </div>
      ...
      @if(auth('professor')->check())
        ...
        <div class="mb-8">
          ...
          <div class="rounded-lg bg-blue-50 p-4">
            ...
            <a href="{{ route('professor.trocarSenha') }}" class="rounded-lg bg-blue-600 px-4 py-2 text-white hover:bg-blue-700">
              Redefinir Senha
            </a>
          </div>
        </div>
