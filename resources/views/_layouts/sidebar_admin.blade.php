...
<div x-cloak :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
  ...
  <nav class="mt-10 text-slate-200">
    <a class="flex items-center px-6 py-2 mt-4 {{ request()->routeIs('admin.dashboard') ? 'bg-gray-700 bg-opacity-25' : 'hover:bg-opacity-25 hover:bg-gray-700 hover:text-gray-100' }}"
    ...
    <a class="flex items-center px-6 py-2 mt-4 {{ request()->routeIs('admin.alunos') ? 'bg-gray-700 bg-opacity-25' : 'hover:bg-opacity-25 hover:bg-gray-700 hover:text-gray-100' }}"
      href="{{ route('admin.create.alunos') }}"
      <svg class="w-8 h-8" viewBox="0 0 18 18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path
