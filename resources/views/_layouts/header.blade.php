<header style="background-color: var(--colorMdWeak)" class="flex items-center justify-between px-6 py-4">
    <div class="flex items-center">
        ...
        <div class="relative mx-4 lg:mx-0">
            <h4 class="text-gray-700 text-3xl font-medium">{{ $titulo }}</h4>
        </div>
    </div>
    ...
    <div class="flex items-center">
        ...
        <div x-data="{ dropdownOpen: false }"  class="relative">
            ...
            <div x-cloak x-show="dropdownOpen" class="absolute right-0 z-10 w-48 mt-2 overflow-hidden bg-white rounded-md shadow-xl">
                ...
                <a href="{{ route('aluno.logout') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Sair</a>
            </div>
        </div>
    </div>
</header>
