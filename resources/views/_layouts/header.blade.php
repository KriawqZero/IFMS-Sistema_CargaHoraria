<header class="bg-zinc-800 flex items-center justify-between px-6 py-4">
    <div class="flex items-center">
        ...
        <div class="relative mx-4 lg:mx-0">
            <h4 class="text-slate-200 text-3xl font-medium">{{ $titulo }}</h4>
        </div>
    </div>

    <div class="flex items-center">
        <div x-data="{ notificationOpen: false }" class="relative">
            <button @click="notificationOpen = ! notificationOpen" class="flex mx-4 text-slate-200 focus:outline-none">
                <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
