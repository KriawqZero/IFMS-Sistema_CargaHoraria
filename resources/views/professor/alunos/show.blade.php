    ...
    <div class="rounded-lg bg-white p-6 shadow-md">
      ...
      <div class="mb-6 flex justify-between">
        ...
        <div class="flex space-x-4">
          <a href="{{ route('professor.alunos.edit', $aluno->id) }}" class="text-gray-600 hover:text-blue-600 hover:bg-blue-200">
          ...
          <form action="{{ route('professor.alunos.destroy', $aluno->id) }}" method="POST">
            @csrf
            @method('DELETE')
            <button type="submit" class="text-red-600 hover:text-red-800 hover:bg-red-200">
