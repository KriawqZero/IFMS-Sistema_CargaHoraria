                    ...
                    <div x-data="{ showModal: false }">
                      ...
                      <div x-show="showModal"
                        ...
                        <div @click.away="showModal = false" class="w-11/12 rounded-lg bg-white p-6 shadow-lg md:w-1/3">
                          <h2 class="mb-4 text-lg font-semibold text-gray-700">Tem certeza que deseja excluir esse professor?
                          ...
                          <div class="flex justify-end space-x-2">
                            ...
                            <form action="{{ route('professor.professores.destroy', ['id' => $professor->id]) }}" method="POST">
                              @csrf
                              @method('DELETE')
                              <button type="submit"
