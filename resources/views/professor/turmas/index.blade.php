        ...
        <tbody>
          @foreach ($turmas as $turma)
            <tr>
              ...
              <td class="border-b border-gray-200 px-4 py-2">{{ $turma->professor->nomeCompleto ?? 'Sem professor' }}</td>
                  ...
                  <div x-data="{ showModal: false }">
                    ...
                    <div x-show="showModal"
                      ...
                      <div @click.away="showModal = false" class="w-11/12 rounded-lg bg-white p-6 shadow-lg md:w-1/3">
                        <h2 class="mb-4 text-lg font-semibold text-gray-700">Tem certeza que deseja excluir esta turma?</h2>
