<div x-data="{ notificationOpen: false }" class="relative">
    ...
    <div x-cloak x-show="notificationOpen"
        ...
        @forelse($notifications as $notification)
            <div class="flex items-center justify-between px-4 py-3 -mx-2 hover:bg-gray-100">
                <form wire:submit.prevent="markAsRead('{{ $notification->id }}')" class="flex items-center px-4 py-3 -mx-2">
                    <button type="submit"
                        class="flex items-center w-full text-left px-4 py-3 -mx-2 {{ $notification->read_at ? 'bg-gray-200 hover:bg-stone-100' : 'bg-white hover:bg-green-200' }} text-gray-600">
                ...
                <button wire:click="removeNotification('{{ $notification->id }}')"
                    class="text-red-500 hover:bg-red-200 p-2">
        ...
        @empty
            <div class="flex items-center px-4 py-3 text-gray-600">
