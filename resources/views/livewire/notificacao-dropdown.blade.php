        ...
        @forelse($notifications as $notification)
            <div class="group flex items-center justify-between px-4 py-3 bg-white rounded-lg shadow hover:shadow-md transition hover:ring-2 ring-green-300">
                ...
                <form action="{{ $url }}" method="GET"
                    ...
                    @endif
                    <button type="submit"
                        class="flex items-center w-full px-4 py-3 text-left space-x-3 {{ $notification->read_at ? 'bg-gray-100 hover:bg-gray-200' : 'bg-green-50 hover:bg-green-100' }} rounded-lg transition"
                ...
                <button
                    ...
                    class="ml-4 text-red-500 hover:bg-red-200 p-2 rounded-lg transition">
