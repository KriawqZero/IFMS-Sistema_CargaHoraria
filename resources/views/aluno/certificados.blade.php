                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    ...
                                    @elseif($certificado->status == 'em_andamento')
                                        <span class="px-2 inline-flex text-xs leading-5 font-bold text-gray-600 disabled">
                                            Em andamento</span>
                                    @else
                                        <span class="px-2 inline-flex text-xs leading-5 font-bold text-red-600">
                                            Inválido</span>
                                    @endif
                                </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                       <div x-data="{ showModal: false, certificadoId: null }">
                                           ...
                                           <a href="javascript:void(0)"
                                              class="bd-gray text-red-500 hover:text-red-800"
                                           ...
                                           <div x-show="showModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center">
                                               <div class="bg-white rounded-lg shadow-lg p-6 w-1/3">
                                                   <h2 class="text-lg font-semibold text-gray-700">Tem certeza que deseja excluir este certificado?</h2>
