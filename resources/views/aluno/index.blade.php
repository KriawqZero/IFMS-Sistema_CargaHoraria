        ...
        <div class="mt-4">
            <div class="-mx-6 flex flex-wrap">
                <div class="mt-0 w-full px-6 sm:w-1/2 md:mt-8 xl:mt-6 xl:w-1/4">
                    <x-master::card iconBg="bg-red-600 bg-opacity-75" titulo="{{ $aluno->nome_completo }}"
                        subtitulo="Aluno(a)">
                ...
                <div class="mt-8 w-full px-6 sm:w-1/2 xl:mt-6 xl:w-1/4">
                    <x-master::card iconBg="bg-green-600 bg-opacity-75"
                        titulo="{{ $aluno->turma->codigo ?? 'Não designado' }}"
                ...
                <div class="mt-8 w-full px-6 sm:w-1/2 xl:mt-6 xl:w-1/4">
                    <x-master::card iconBg="bg-fuchsia-600 bg-opacity-75"
                        titulo="{{ count($aluno->certificados()->get()) }}" subtitulo="Certificados Enviados">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-white" fill="white"
                            viewBox="0 0 16 16">
                            <path
